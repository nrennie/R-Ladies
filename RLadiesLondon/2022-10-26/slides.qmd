...
#| fig-height: 3
#| fig-align: center
#| fig-alt: "A stream graph showing the use of R for the author between 2014 and present day. An increase is seen from 2019, and then more significantly in the last year."
library(tibble)
library(ggplot2)
library(ggstream)
library(showtext)
...
<p align="center">
  <img src="https://github.com/nrennie/tidytuesday/blob/main/2022/2022-05-10/20220510.png?raw=true" width="60%" alt="A bar chart showing the number of books by the top 10 authors on the New York bestsellers list, where the bars are constructed of book titles stacked on top of each other.">
</p>
...
<p align="center">
<img src="https://github.com/nrennie/30daychartchallenge/blob/main/2022/viz/day_29_final.png?raw=true" width="40%" alt="A flowchart showing the story of goldilocks. A drawing of the bears and goldilocks has been added to the top-right corner.">
</p>
...
#| eval: true
#| echo: false
theme_set(theme_grey(base_size = 40) + theme(legend.position = "none"))
```
...
#| fig-alt: "A scatter plot of the mtcars data set from ggplot2 showing mpg on the x axis and disp on the y axis. The title of the plot is reads My Plot Title."
ggplot(data = mtcars,
       mapping = aes(x = mpg,
                     y = disp)) +
  geom_point() +
...
#| eval: true
#| echo: true
#| fig-alt: "A scatter plot of the mtcars data set from ggplot2 showing mpg on the x axis and disp on the y axis. The title of the plot is reads My Plot Title and is now shown in a different font."
#| output-location: column
...
```{r}
#| fig-alt: "Example of a bar chart showing A, B, and C on the x axis and 1, 2, and 3 on the y axis. Bars are coloured based on the x axis values."
#| echo: false
#| eval: true
ggplot(data = tibble(x = c("A", "B", "C"),
                     y = 1:3)) +
...
```{r}
#| fig-alt: "Example of a bar chart showing A, B, and C on the x axis and 1, 2, and 3 on the y axis. Bars are all coloured blue."
#| echo: false
#| eval: true
ggplot(data = tibble(x = c("A", "B", "C"),
                     y = 1:3)) +
...
```{r}
#| fig-alt: "Example of a bar chart showing A, B, and C on the x axis and 1, 2, and 3 on the y axis. Background is coloured blue."
#| echo: false
#| eval: true
ggplot(data = tibble(x = c("A", "B", "C"),
                     y = 1:3)) +
...
#| fig-alt: "Bar chart showing the number of lemurs for three different species with colorbrewer Dark2 palette colours for the bars."
ggplot(data = lemurs, 
       aes(x = name,
           y = n,
           fill = name)) +
...
#| fig-alt: "Bar chart showing the number of lemurs for three different species with colours from the Prism palette from rcartocolor."
library(rcartocolor)
ggplot(data = lemurs, 
       aes(x = name,
           y = n,
...
#| fig-alt: "Bar chart showing the number of lemurs for three different species with colours chosen manually."
ggplot(data = lemurs, 
       aes(x = name,
           y = n,
           fill = name)) +
...
#| eval: true
#| echo: false
theme_set(theme_grey(base_size = 20) + theme(legend.position = "none"))
```
...
#| eval: true
#| fig-align: center
#| fig-alt: "Grid showing how the previous bar chart looks with different types of colorblindness"
#| fig-height: 7
#| fig-width: 13
